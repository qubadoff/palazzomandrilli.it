...
class ArtShopResource extends Resource
{
    protected static ?string $model = ArtShop::class;
    ...
    {
        return [
            'index' => Pages\ListArtShops::route('/'),
            'create' => Pages\CreateArtShop::route('/create'),
            'edit' => Pages\EditArtShop::route('/{record}/edit'),
        ];
    }
}
